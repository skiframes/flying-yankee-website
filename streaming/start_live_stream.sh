...
# Camera settings - primary and fallback
PRIMARY_CAMERA="192.168.0.101"
FALLBACK_CAMERA="192.168.0.103"
CAMERA_IP="${2:-}"  # Will be auto-detected if not provided
CAMERA_USER="j40"
CAMERA_PASS="J40j40j40"
RTMP_URL="rtmp://44.215.230.146:1935/live/stream1"
